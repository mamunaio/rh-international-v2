...
const ServicePageLayout = ({
  ...
  return (
    <div className="min-h-screen bg-background relative selection:bg-primary/20 selection:text-primary overflow-x-clip">
        ...
        <section className="px-6 pb-12 md:pb-16">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h1
                className="text-4xl md:text-6xl font-bold text-foreground mb-8 tracking-tight leading-[1.05]"
              ...
              >
                {title.split(" ").map((word, i, arr) => (
                  <span
                    ...
                    className={
                      i === arr.length - 1
                        ? "text-gradient-cyan drop-shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                        : ""
                    }
                  >
                    {word}{" "}
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 relative z-10">
                  {highlights.map((h, i) => {
                    ...
                    const [titlePart, descPart] = hasColon
                      ? h.split(/:(.+)/)
                      : [h, ""];
                      ...
                      <div key={h} className="flex gap-6 group">
                        ...
                        <div>
                          <span
                            className={
                              hasColon
                                ? "font-bold text-foreground text-2xl block mb-3"
                                : "text-xl text-foreground font-medium"
                            }
                          >
                            {titlePart}
                          </span>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-base text-muted-foreground mb-12 max-w-2xl mx-auto">
                Get in touch with our experts today and discover how our global
