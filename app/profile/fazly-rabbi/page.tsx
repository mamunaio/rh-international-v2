...
export default function FazlyRabbiProfile() {
          ...
          <div className="relative rounded-3xl border border-border/20 bg-card/30 backdrop-blur-md overflow-hidden pb-10">
            ...
            <div className="relative pt-10 px-6 sm:px-10 text-center">
              ...
              >
                ...
                >
                  <Image 
                    src="/images/team/MD.Fozle Rabbi.jpeg" 
                    alt="Sheikh Fozle Rabby" 
                    width={144}
                    height={144}
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-8">
                ...
                <span className="text-sm font-semibold text-primary tracking-wide">Office Executive</span>
              </div>

              <p className="text-muted-foreground text-base leading-relaxed mb-8 max-w-sm mx-auto">
                Rabby is the backbone of our office management. He brings precision and dedication to our daily administrative tasks, ensuring a productive environment for everyone.
              </p>
              ...
              <div className="flex justify-center gap-3 mb-8">
                {[
                  ...
                  { icon: Mail, label: "Email", href: "mailto:Sheikfazlerabbi101@gmail.com" },
              ...
              <motion.button 
                onClick={() => {
                  const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:Rabby;Sheikh Fozle;;;\nFN:Sheikh Fozle Rabby\nORG:RH International\nTITLE:Office Executive\nEMAIL;TYPE=INTERNET:Sheikfazlerabbi101@gmail.com\nURL:https://rhinternationalsc.com\nEND:VCARD`;
                  const blob = new Blob([vcard], { type: "text/vcard" });
                  const url = URL.createObjectURL(blob);
                  const link = document.createElement("a");
                  link.href = url;
                  link.download = "Sheikh_Fozle_Rabby.vcf";
