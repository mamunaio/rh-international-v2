          ...
          <div className="relative rounded-3xl border border-border/20 bg-card/30 backdrop-blur-md overflow-hidden pb-10">
            ...
            <div className="relative pt-10 px-6 sm:px-10 text-center">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-8">
                ...
                <span className="text-sm font-semibold text-primary tracking-wide">Chief Technology Officer (CTO)</span>
              </div>

              <p className="text-muted-foreground text-base leading-relaxed mb-8 max-w-sm mx-auto">
                As the Chief Technology Officer at RH International Sourcing Center, Mamun drives the digital strategy across the company’s global operations. Working closely with the executive team, he ensures all technology initiatives perfectly align with broader business goals, from government tenders to travel consultation and procurement. He oversees the architecture of the company’s digital platforms and performance-tracking systems, enabling data-driven decisions that strengthen international service delivery.
              </p>
              ...
              <div className="flex justify-center gap-3 mb-8">
                {[
                  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/mdmamunhossain-webdev/" },
                  { icon: Mail, label: "Email", href: "mailto:mamun@rhinternationalsc.com" },
                  { icon: Globe, label: "Website", href: "https://rhinternationalsc.com/profile/md-mamun-hossain" },
                ].map((item, idx) => (
                  <motion.a
                    key={idx}
                    href={item.href}
              ...
              <motion.button 
                onClick={() => {
                  const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:Hossain;Md Mamun;;;\nFN:Md Mamun Hossain\nORG:RH International\nTITLE:Chief Technology Officer (CTO)\nEMAIL;TYPE=INTERNET:mamun@rhinternationalsc.com\nURL:https://rhinternationalsc.com/profile/md-mamun-hossain\nEND:VCARD`;
