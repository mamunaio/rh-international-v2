          ...
          <div className="relative rounded-3xl border border-border/20 bg-card/30 backdrop-blur-md overflow-hidden pb-10">
            ...
            <div className="relative pt-10 px-6 sm:px-10 text-center">
              ...
              >
                ...
                >
                  <Image 
                    src="/images/team/Fahim-Hasan.jpeg" 
                    alt="Fahim Hasan" 
                    width={144}
                    height={144}
              ...
              <div className="flex justify-center gap-3 mb-8">
                {[
                  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/fahim-hasan003" },
                  { icon: Mail, label: "Email", href: "mailto:fahim@rhinternationalsc.com" },
              ...
              <motion.button 
                onClick={() => {
                  const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:Hasan;Fahim;;;\nFN:Fahim Hasan\nORG:RH International\nTITLE:Operations Manager\nEMAIL;TYPE=INTERNET:fahim@rhinternationalsc.com\nURL:https://www.linkedin.com/in/fahim-hasan003\nEND:VCARD`;
