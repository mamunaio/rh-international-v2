...
const teamMembers = [
  ...
  },
  {
    ...
    initials: "FH",
    image: "/images/team/Fahim-Hasan.jpeg",
    objectPosition: "top",
  ...
  {
    name: "Sheikh Fozle Rabby",
    role: "Office Executive",

    bio: "Rabby is the backbone of our office management. He brings precision and dedication to our daily administrative tasks, ensuring a productive environment for everyone.",
    initials: "MFR",
...
const TeamCard = ({ member, index }: { member: any; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-lg group h-full"
    >
      {/* Gradient border */}
